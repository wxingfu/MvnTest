package com.wxf.demo.web.aop;

import com.alibaba.fastjson.JSON;
import com.wxf.demo.web.common.BusinessException;
import com.wxf.demo.web.util.RedisUtil;
...
public class PreventAop {
     ...
     * 切入点
     */
    @Pointcut("@annotation(com.wxf.demo.web.aop.Prevent)")
