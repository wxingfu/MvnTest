...
public class PDMReference {
    ...
    public PDMReference(String id, String name, String code, String constraintName, PDMTable parentTable, PDMTable childTable, int updateConstraint, int deleteConstraint, String implementationType, ArrayList<PDMReferenceJoin> joins) {
        this.id = id;
        this.name = name;
        this.code = code;
