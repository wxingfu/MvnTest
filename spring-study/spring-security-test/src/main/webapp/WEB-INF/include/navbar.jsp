...
<div class="layui-header">
    <div class="layui-logo" onclick="location.href='${pageContext.request.contextPath }/main.html'">武林秘籍管理系统</div>
    ...
    <ul class="layui-nav layui-layout-right">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="http://t.cn/RCzsdCq" class="layui-nav-img">张无忌</a>
            <dl class="layui-nav-child">
                <dd>
                    <a href="">基本资料</a>
                </dd>
